...
Partial Class pelunasan_piutang
    ...
    Private Sub InitializeComponent()
        ...
        Me.daftarbayar.EmbeddedNavigator.Buttons.Append.Visible = False
        Me.daftarbayar.EmbeddedNavigator.Buttons.CancelEdit.Visible = False
        Me.daftarbayar.EmbeddedNavigator.Buttons.Edit.Visible = False
        Me.daftarbayar.EmbeddedNavigator.Buttons.EndEdit.Visible = False
        ...
        Me.daftarbayar.RepositoryItems.AddRange(New DevExpress.XtraEditors.Repository.RepositoryItem() {Me.RepositoryItemLookUpEdit1, Me.RepositoryItemTextEdit1, Me.RepositoryItemLookUpEdit2})
        ...
        'pembayaran
        '
        Me.pembayaran.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.nama_bank, Me.colketerangan, Me.colnominal, Me.coltruk})
        ...
        Me.nama_bank.ColumnEdit = Me.RepositoryItemLookUpEdit1
        Me.nama_bank.FieldName = "nama_bank"
        Me.nama_bank.Name = "nama_bank"
        Me.nama_bank.Visible = True
        Me.nama_bank.VisibleIndex = 0
        Me.nama_bank.Width = 233
        '
