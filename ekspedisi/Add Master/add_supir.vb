...
Public Class add_supir
    ...
    Private Sub add_supir_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        Try
            If cek = True Then
    ...
    Private Sub simpan_Click(sender As Object, e As EventArgs) Handles simpan.Click
        ...
        If nama.Text = "" Or alamat.Text = "" Or tel1.Text = "" Or tel2.Text = "" Or kota.Text = "" Or RichTextBox1.Text = "" Then
