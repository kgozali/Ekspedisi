        ...
        Try
            ...
            If flagval Then
                ...
                For i = 0 To DataSet1.Tables.Item("datadetil").Rows.Count - 1
                    ...
                    command.CommandText = "insert into dtrans_kas (id_transaksi_kas,tgl,nominal,id_akun_detil,id_truk,keterangan,urutan) VALUES ('" & TextBox1.Text & "','" & Format(DateTimePicker1.Value, "yyyy-MM-dd") & "'," & dtrow("nominal") & ",'" & dtrow("id_akun_detil") & "','" & dtrow("id_truk") & "','" & CekTandaPetik(RichTextBox1.Text) & "'," & i + 1 & ")"
                    command.ExecuteNonQuery()
