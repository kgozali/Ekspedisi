Public Class daftar_hutang_karyawan 
    ...
    Private Sub daftarhutang_DoubleClick(sender As Object, e As EventArgs) Handles daftarhutang.DoubleClick
        Try
            ...
            data = DtTablebayarcek("SELECT b.id_booking `Kode Booking`,harga_supir_total `Total Nominal`, dp_awal_supir `DP Awal`,harga_supir_total-dp_awal_supir `Sisa Hutang` FROM  `msupir` ms, booking_truk b WHERE b.id_supir=ms.id_supir and ms.s='1' and status_bayar_supir='1'  and ms.id_supir='" & hutang.GetRowCellValue(hutang.FocusedRowHandle, "Kode Supir") & "' and b.del='0'")
